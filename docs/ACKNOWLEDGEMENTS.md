...
Image Prompt Book exists because these authors shared their prompts. Thank you.

Image Prompt Book 的每个案例都来自作者的公开分享，感谢他们。

| Prompt | Author / 作者 | Source / 来源 | License / 许可 |
| --- | --- | --- | --- |
...
本站的中英文版本与可调选项是我们的改编，不代表原作者认可。各许可的具体范围见 README 的[许可](../README.zh-CN.md#许可)一节。

Is your prompt here and the credit wrong or missing? Open a [rights request](https://github.com/thinkingjimmy/Image-Prompt-Book/issues/new?template=rights-request.yml). / 署名有误或遗漏？请提交[权利反馈](https://github.com/thinkingjimmy/Image-Prompt-Book/issues/new?template=rights-request.yml)。
